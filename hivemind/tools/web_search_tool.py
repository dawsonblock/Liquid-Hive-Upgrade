...
class WebSearchTool(BaseTool):
    ...
    async def execute(self, parameters: Dict[str, Any]) -> ToolResult:
        ...
        try:
            ...
            results = await self._duckduckgo_search(query, max_results, region, safe_search)
    ...
    async def _duckduckgo_search(self, query: str, max_results: int, region: str, safe_search: str) -> List[Dict[str, Any]]:
        ...
        async with aiohttp.ClientSession(timeout=timeout) as session:
            ...
            async with session.get(url, params=params) as response:
                ...
                if len(results) < max_results:
                    web_results = await self._duckduckgo_web_search(session, query, max_results - len(results))
                    results.extend(web_results)
                
                return results[:max_results]
    
    async def _duckduckgo_web_search(self, session: aiohttp.ClientSession, query: str, max_results: int) -> List[Dict[str, Any]]:
