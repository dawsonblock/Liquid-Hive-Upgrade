...
class TestBudgetTracking:
    ...
    def test_budget_status_check(self):
        ...
        config = RouterConfig(max_oracle_tokens_per_day=1000, max_oracle_usd_per_day=10.0)
    ...
    def test_usage_recording(self):
        ...
        response = GenResponse(
            content="Test", provider="test", prompt_tokens=10, output_tokens=5, cost_usd=0.50
        )
