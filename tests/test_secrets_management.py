...
class TestSecretsManager:
    ...
    def test_aws_secrets_manager_initialization(self):
        ...
        with patch("boto3.client") as mock_boto3:
            ...
            mock_client.describe_secret.side_effect = Exception(
    ...
    def test_error_handling_vault_retrieval(self):
        ...
        with patch.dict(
            ...
            with patch("hvac.Client") as mock_client:
                ...
                mock_instance.secrets.kv.v1.read_secret.side_effect = Exception(
                    "Network error"
                )
                mock_client.return_value = mock_instance
    ...
    def test_settings_integration(self):
        ...
        with patch.dict(
            ...
            with patch("hivemind.config.secrets_manager") as mock_manager:
                ...
                mock_manager.get_prometheus_url.return_value = (
                    "http://secrets-prometheus:9090"
                )
