...
export default function App() {
  ...
  return _jsx(Provider, {
    store: store,
    children: _jsx(ProvidersProvider, {
              ...
              children: [
                ...
                _jsx(Tooltip, {
                  ...
                  children: _jsx(IconButton, {
                    ...
                    children:
                      mode === 'dark'
                        ? _jsx(WbSunnyRoundedIcon, {})
                        : _jsx(DarkModeRoundedIcon, {}),
                  }),
                }),
              ],
            }),
                ...
                children: [
                  _jsx(ListItem, {
                    ...
                    children: _jsxs(ListItemButton, {
                      ...
                      children: [
                        _jsx(ListItemIcon, { children: _jsx(StreamIcon, {}) }),
                        _jsx(ListItemText, { primary: 'Streaming Chat' }),
                      ],
                    }),
                  }),
                  _jsx(ListItem, {
                    ...
                    children: _jsxs(ListItemButton, {
                      ...
                      children: [
                        _jsx(ListItemIcon, { children: _jsx(ChatIcon, {}) }),
                        _jsx(ListItemText, { primary: 'Classic Chat' }),
                      ],
                    }),
                  }),
                  _jsx(Divider, { sx: { my: 1 } }),
                  _jsx(ListItem, {
                    disablePadding: true,
                    children: _jsxs(ListItemButton, {
                      selected: panel === 'system',
                      onClick: () => setPanel('system'),
                      children: [
                        _jsx(ListItemIcon, { children: _jsx(DashboardIcon, {}) }),
                        _jsx(ListItemText, { primary: 'System Console' }),
                      ],
                    }),
                  }),
                  _jsx(ListItem, {
                    disablePadding: true,
                    children: _jsxs(ListItemButton, {
                      selected: panel === 'cache',
                      onClick: () => setPanel('cache'),
                      children: [
                        _jsx(ListItemIcon, { children: _jsx(SettingsIcon, {}) }),
                        _jsx(ListItemText, { primary: 'Cache Admin' }),
                      ],
                    }),
                  }),
                  _jsx(ListItem, {
                    disablePadding: true,
                    children: _jsxs(ListItemButton, {
                      selected: panel === 'secrets',
                      onClick: () => setPanel('secrets'),
                      children: [
                        _jsx(ListItemIcon, { children: _jsx(VpnKeyIcon, {}) }),
                        _jsx(ListItemText, { primary: 'Secrets' }),
                      ],
                    }),
                  }),
                  _jsx(ListItem, {
                    disablePadding: true,
                    children: _jsxs(ListItemButton, {
                      selected: panel === 'forge',
                      onClick: () => setPanel('forge'),
                      children: [
                        _jsx(ListItemIcon, { children: _jsx(SettingsIcon, {}) }),
                        _jsx(ListItemText, { primary: 'Cognitive Forge' }),
                      ],
                    }),
                  }),
                ],
          ...
          _jsxs(Box, {
            ...
            children: [
              ...
              _jsxs(Box, {
                ...
                children: [
                  panel === 'streaming' && _jsx(StreamingChatPanel, {}),
                  panel === 'chat' && _jsx(ChatPanel, {}),
                  panel === 'system' && _jsx(SystemPanel, {}),
                  panel === 'cache' && _jsx(CacheAdminPanel, {}),
                  panel === 'secrets' && _jsx(SecretsPanel, {}),
                  panel === 'forge' && _jsx(ForgePanel, {}),
                ],
              }),
            ],
          }),
...
function HeaderPollingChip() {
  ...
  try {
    ...
    return _jsx(Tooltip, {
      title: 'Providers status polling',
      children: _jsx(Chip, {
        size: 'small',
        label: label,
        color: color,
