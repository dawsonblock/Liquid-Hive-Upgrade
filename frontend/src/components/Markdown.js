            ...
            code(nodeProps) {
                ...
                if (!Highlighter || !styles) {
                    return (_jsxs(Box, { sx: {
                        ...
                        }, children: [_jsx(Box, { sx: { position: 'absolute', right: 6, top: 6, zIndex: 1 }, children: _jsx(Tooltip, { title: copied === key ? 'Copied' : 'Copy', children: _jsx(IconButton, { size: 'small', onClick: () => onCopy(code, key), "aria-label": 'Copy code block', children: copied === key ? (_jsx(CheckIcon, { fontSize: 'small' })) : (_jsx(ContentCopyIcon, { fontSize: 'small' })) }) }) }), _jsx("pre", { style: {
                                    margin: 0,
                                    padding: '14px 16px',
                                    fontSize: '0.875rem',
                                    overflow: 'auto',
                ...
                return (_jsxs(Box, { sx: {
                        ...
                        overflow: 'hidden',
                        border: t => `1px solid ${t.palette.divider}`,
                    }, children: [_jsx(Box, { sx: { position: 'absolute', right: 6, top: 6, zIndex: 1 }, children: _jsx(Tooltip, { title: copied === key ? 'Copied' : 'Copy', children: _jsx(IconButton, { size: 'small', onClick: () => onCopy(code, key), "aria-label": 'Copy code block', children: copied === key ? (_jsx(CheckIcon, { fontSize: 'small' })) : (_jsx(ContentCopyIcon, { fontSize: 'small' })) }) }) }), _jsx(SyntaxHighlighter, { style: style, language: match?.[1] || 'text', PreTag: 'div', customStyle: { margin: 0, padding: '14px 16px', background: 'transparent' }, codeTagProps: { style: { fontSize: '0.875rem' } }, ...props, children: code })] }));
            },
        }, children: children }));
}
