    ...
    children: [
        ...
        children: _jsx(Paper, {
          ...
          children: _jsxs(Stack, {
            ...
            children: [
              ...
              analytics &&
                _jsxs(_Fragment, {
                  children: [
                    ...
                    _jsx(Chip, { label: `Entries: ${entries}`, variant: 'outlined' }),
              ...
              _jsx(Button, {
                onClick: refreshAll,
                startIcon: loading ? _jsx(CircularProgress, { size: 16 }) : _jsx(RefreshIcon, {}),
                variant: 'outlined',
                size: 'small',
                children: 'Refresh',
              }),
      ...
      _jsx(Grid, {
        ...
        children: _jsxs(Paper, {
          ...
          sx: { p: 2 },
          children: [
            _jsx(Typography, { variant: 'subtitle1', gutterBottom: true, children: 'Health' }),
            health
              ? _jsxs(Stack, {
                  spacing: 1,
                  children: [
                    _jsxs(Typography, {
                      variant: 'body2',
                      children: ['Status: ', _jsx('b', { children: health.status })],
                    }),
                    _jsxs(Typography, {
                      variant: 'body2',
                      children: [
                        ...
                        _jsx('span', {
                          style: smallMono,
                          children: health.driver || health.backend || '—',
                        }),
                      ],
                    }),
                    health.strategy &&
                      _jsxs(Typography, {
                        variant: 'body2',
                        children: ['Strategy: ', _jsx('b', { children: health.strategy })],
                      }),
                    typeof health.similarity_threshold === 'number' &&
                      _jsxs(Typography, {
                        ...
                        children: [
                          'Threshold: ',
                          _jsx('b', { children: health.similarity_threshold }),
                        ],
                      }),
                    health.redis_url &&
                      _jsxs(Typography, {
                        ...
                        children: [
                          'Redis: ',
                          _jsx('span', { style: smallMono, children: health.redis_url }),
                        ],
                      }),
                    typeof health.redis_connected === 'boolean' &&
                      _jsxs(Typography, {
                        ...
                        children: [
                          'Redis Connected: ',
                          _jsx('b', { children: String(health.redis_connected) }),
                        ],
                      }),
                    typeof health.in_memory === 'boolean' &&
                      _jsxs(Typography, {
                        ...
                        children: [
                          'In-Memory: ',
                          _jsx('b', { children: String(health.in_memory) }),
                        ],
                      }),
                  ],
                })
              ...
              children: [
                ...
                _jsxs(Stack, {
                  ...
                  children: [
                    ...
                    _jsx(Button, {
                      variant: 'outlined',
                      startIcon: optimizing
                        ? _jsx(CircularProgress, { size: 16 })
                        : _jsx(AutoFixHighIcon, {}),
                      onClick: onOptimize,
                      disabled: optimizing,
                      children: 'Optimize',
                    }),
                ...
                lastClear &&
                  _jsx(Typography, {
                    ...
                    children: JSON.stringify(lastClear, null, 2),
                  }),
              ],
            }),
          ],
        ...
        children: [
          ...
          status &&
            _jsxs(Paper, {
              ...
              sx: { p: 2, mt: 2 },
              children: [
                _jsx(Typography, { variant: 'subtitle1', gutterBottom: true, children: 'Status' }),
                _jsx(Typography, {
                  variant: 'caption',
                  sx: { whiteSpace: 'pre-wrap' },
          ...
          report &&
            _jsxs(Paper, {
              ...
              sx: { p: 2, mt: 2 },
              children: [
                _jsx(Typography, { variant: 'subtitle1', gutterBottom: true, children: 'Report' }),
                _jsx(Typography, {
                  variant: 'caption',
                  sx: { whiteSpace: 'pre-wrap' },
