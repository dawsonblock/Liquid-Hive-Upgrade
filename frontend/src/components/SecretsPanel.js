...
export default function SecretsPanel() {
  ...
  return _jsxs(Box, {
    children: [
      _jsx(Typography, { variant: 'h5', gutterBottom: true, children: 'Secrets & API Tokens' }),
      _jsxs(Typography, {
        variant: 'body2',
        color: 'text.secondary',
        gutterBottom: true,
        children: ['Provider: ', _jsx('b', { children: provider })],
      }),
      _jsx(Alert, {
        severity: 'info',
        sx: { mb: 2 },
                ...
                children: _jsxs(Stack, {
                  ...
                  children: [
                    _jsxs(Stack, {
                      ...
                      spacing: 1,
                      children: [
                        _jsx(Typography, { variant: 'subtitle1', children: s.label }),
                        _jsx(Chip, {
                          size: 'small',
                    ...
                    _jsxs(Stack, {
                      ...
                      children: [
                        _jsx(Button, {
                          ...
                          children: saving[s.key] ? 'Saving…' : 'Save',
                        }),
                        _jsx(Divider, { orientation: 'vertical', flexItem: true }),
                        _jsx(Typography, {
                          variant: 'caption',
                          color: 'text.secondary',
                          children: 'Key is stored securely server-side',
                        }),
                      ],
                    }),
                  ],
        ...
        children: _jsxs(Stack, {
          ...
          children: [
            _jsxs(Stack, {
              ...
              alignItems: 'center',
              children: [
                _jsx(TimerIcon, { fontSize: 'small' }),
                _jsx(Typography, { variant: 'subtitle1', children: 'Providers Polling' }),
              ],
            }),
            _jsxs(Stack, {
              direction: 'row',
              ...
              alignItems: 'center',
              children: [
                _jsx(Typography, { variant: 'caption', children: 'Auto Refresh' }),
                _jsx(Switch, {
                  size: 'small',
                  checked: !!autoRefresh,
            ...
            _jsxs(FormControl, {
              ...
              sx: { minWidth: 160 },
              children: [
                _jsx(InputLabel, { id: 'poll-interval-label', children: 'Interval' }),
                _jsxs(Select, {
                  ...
                  children: [
                    _jsx(MenuItem, { value: 5000, children: '5 seconds' }),
                    _jsx(MenuItem, { value: 10000, children: '10 seconds' }),
                    _jsx(MenuItem, { value: 15000, children: '15 seconds' }),
                    _jsx(MenuItem, { value: 30000, children: '30 seconds' }),
                    _jsx(MenuItem, { value: 60000, children: '60 seconds' }),
                  ],
                }),
              ],
            }),
        ...
        children: [
            ...
            children: [
              ...
              _jsx(Grid, {
                ...
                children: _jsxs(Stack, {
                  ...
                  sx: { height: '100%' },
                  children: [
                    _jsx(Typography, { variant: 'body2', children: 'Preload' }),
                    _jsx(Switch, {
                      checked: qwenPreload,
                      onChange: e => setQwenPreload(e.target.checked),
                    }),
                  ],
                }),
              }),
              _jsx(Grid, {
                ...
                children: _jsxs(Stack, {
                  ...
                  sx: { height: '100%' },
                  children: [
                    _jsx(Typography, { variant: 'body2', children: 'Autoload on use' }),
                    _jsx(Switch, {
                      checked: qwenAutoload,
                      onChange: e => setQwenAutoload(e.target.checked),
                    }),
                  ],
                }),
              }),
          ...
          _jsxs(Stack, {
            ...
            children: [
              _jsx(Button, {
                variant: 'outlined',
                onClick: applyQwenSettings,
                children: 'Save Qwen Settings',
              }),
              _jsx(Button, {
                variant: 'outlined',
                color: 'secondary',
                onClick: onReload,
                children: 'Reload Router',
              }),
              _jsx(Button, {
                variant: 'contained',
                color: 'primary',
                onClick: warmQwenNow,
                disabled: warming,
                children: warming ? 'Warming…' : 'Warm Qwen Now',
              }),
            ],
          }),
          _jsx(Typography, {
        ...
        _jsxs(Paper, {
          ...
          children: [
            _jsxs(Stack, {
              ...
              children: [
                _jsx(Typography, { variant: 'subtitle1', children: 'Provider Status' }),
                _jsx(Button, {
                  size: 'small',
                  variant: 'outlined',
                  onClick: refreshProviders,
                  startIcon: _jsx(RefreshIcon, {}),
                  disabled: providersLoading,
                  children: providersLoading ? 'Refreshing…' : 'Refresh',
                }),
              ],
            }),
            _jsx(Grid, {
      ...
      message && _jsx(Alert, { sx: { mt: 2 }, severity: 'success', children: message }),
      error && _jsx(Alert, { sx: { mt: 2 }, severity: 'error', children: error }),
      _jsx(Stack, {
        direction: { xs: 'column', sm: 'row' },
        spacing: 1,
        sx: { mt: 2 },
        children: _jsx(Button, {
          variant: 'outlined',
          onClick: onReload,
          children: 'Reload Router (apply secrets)',
        }),
      }),
    ],
  });
