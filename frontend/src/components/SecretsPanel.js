    ...
    const warmQwenNow = async () => {
        ...
        try {
            ...
            if (r.error) {
                ...
                setMessage(r.status === 'already_loaded'
                    ? 'Qwen already loaded'
                    : r.status === 'warmed'
                        ? 'Qwen warmed'
                        : 'Qwen warm failed');
