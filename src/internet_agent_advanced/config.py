...
TRUSTED_DOMAINS_TIER1 = {
    "nasa.gov","nih.gov","nist.gov","cdc.gov","fda.gov","gc.ca","canada.ca","statcan.gc.ca",
    "europa.eu","ec.europa.eu","who.int","un.org","oecd.org","imf.org","worldbank.org"
}
TRUSTED_DOMAINS_TIER2 = {
    "nature.com","sciencemag.org","sciencedirect.com","springer.com","cell.com",
    "plos.org","arxiv.org","pubmed.ncbi.nlm.nih.gov","ieee.org","acm.org","siam.org"
}
TRUSTED_DOMAINS_TIER3 = {
    "reuters.com","apnews.com","bbc.com","economist.com","financialtimes.com",
    "bloomberg.com","federalreserve.gov","tradingeconomics.com"
}
TRUSTED_DOMAINS_TIER4 = {
    "github.com","docs.github.com","pypi.org","npmjs.com","cran.r-project.org",
    "huggingface.co","huggingface.co/docs"
}
BASE_TRUST_SCORES = {"tld": 40, "tier1": 95, "tier2": 85, "tier3": 70, "tier4": 75, "https_bonus": 5}
