...
Use your advanced reasoning capabilities to provide platinum-quality refinement.""",
        ...
        for attempt in range(self._max_retries + 1):
            try:
                async with httpx.AsyncClient(
                    timeout=180
                ) as client:  # Longer timeout for reasoning
                ...
                if e.response.status_code == 429:  # Rate limit
                    if attempt < self._max_retries:
                        ...
                        logging.warning(
                            f"DeepSeek R1 rate limited, retrying in {backoff}s"
                        )
    ...
    def _enhanced_stub_response(
        self, prompt: str, error: Optional[str] = None
    ) -> Dict[str, Any]:
    ...
    def get_cost_comparison(self) -> Dict[str, Any]:
        ...
        comparison = {
            ...
            "gpt4o_equivalent": {
                ...
                "estimated_cost": (
                    (self.total_tokens * gpt4o_input_cost / 1000)
