...
class SecretsManager:
    ...
    def get_secret(
        self, secret_path: str, default: Optional[Any] = None
    ) -> Optional[Any]:
        """
    ...
    def _get_aws_secret(
        self, secret_name: str, default: Optional[Any] = None
    ) -> Optional[Any]:
    ...
    def _get_env_secret(
        self, env_var: str, default: Optional[Any] = None
    ) -> Optional[Any]:
    ...
    def store_secret(self, secret_path: str, value: Union[str, Dict[str, Any]]) -> bool:
        ...
        try:
            if self._provider == SecretProvider.VAULT and self._vault_client:
                ...
                logger.warning(
                    f"Secret storage not supported for provider {self._provider}"
                )
                return False
        ...
        if boto3:
            try:
                if self._aws_client:
                    ...
                    health["providers"]["aws_secrets_manager"] = {
