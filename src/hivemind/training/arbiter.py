...
class Arbiter:
    ...
    def __init__(self, settings: Optional[Any] = None):
        ...
        if not api_key:
            self.logger.warning(
                "DEEPSEEK_API_KEY not found. Arbiter will use fallback mode."
            )
            return
    ...
    async def refine(
        ...
        refinement_prompt = self._build_refinement_prompt(
            original_prompt, synthesized_answer
        )
        ...
        self.logger.info(
            "Primary oracle failed, escalating to DeepSeek-R1 reasoning mode"
        )
...
Respond in JSON format:
{
    ...
    "final_platinum_answer": "The refined, improved version with enhanced clarity and accuracy"
        ...
        try:
            ...
            if parsed_response:
                ...
                parsed_response["reasoning_tokens"] = getattr(
    ...
    def _build_refinement_prompt(
        self, original_prompt: str, synthesized_answer: str
    ) -> str:
...
Please analyze and refine this answer, providing a higher-quality version."""
    ...
    async def _log_refinement_result(
        ...
        try:
            ...
            log_entry = {
                ...
                "final_platinum_answer": refined_result.get(
                    "final_platinum_answer", ""
                ),
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "secondary_oracle": (
                "DeepSeek-R1" if self.secondary_oracle else "unavailable"
            ),
