...
class Arbiter:
    ...
    async def refine(self, original_prompt: str, synthesized_answer: str, 
        ...
        if primary_result["success"]:
            ...
            await self._log_refinement_result(original_prompt, synthesized_answer, 
                                            primary_result["response"], "DeepSeek-V3", 
        ...
        if secondary_result["success"]:
            ...
            await self._log_refinement_result(original_prompt, synthesized_answer,
                                            secondary_result["response"], "DeepSeek-R1 (Fallback)",
                                            time.time() - start_time, metadata, escalated=True)
        ...
        await self._log_refinement_result(original_prompt, synthesized_answer,
                                        ...
                                        time.time() - start_time, metadata, failed=True)
...
Please analyze and refine this answer, providing a higher-quality version."""
    ...
    async def _log_refinement_result(self, original_prompt: str, synthesized_answer: str,
                                   refined_result: Dict[str, Any], corrector_model: str,
                                   processing_time: float, metadata: Dict[str, Any],
                                   escalated: bool = False, failed: bool = False) -> None:
