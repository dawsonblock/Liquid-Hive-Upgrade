    ...
    async def execute(self, parameters: Dict[str, Any]) -> ToolResult:
        ...
        try:
            if info_type == "basic":
                ...
                return ToolResult(
                    success=False, error=f"Unknown info type: {info_type}"
                )
            ...
            return ToolResult(
                success=False, error=f"System information gathering failed: {str(e)}"
            )
        ...
        for issue in issues:
            if "CPU usage" in issue:
                recommendations.append(
                    "Consider closing unnecessary applications or processes"
                )
                recommendations.append(
                    "Check for processes consuming high CPU resources"
                )
                ...
                recommendations.append(
                    "Consider upgrading hardware if load is consistently high"
                )
