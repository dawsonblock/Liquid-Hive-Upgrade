...
class SystemInfoTool(BaseTool):
    ...
    def parameters(self) -> List[ToolParameter]:
        return [
            ToolParameter(
                ...
                required=True,
                choices=[
                    "basic", "cpu", "memory", "disk", "network", 
                    "processes", "environment", "health", "comprehensive"
                ]
            ),
            ToolParameter(
    ...
    def _get_comprehensive_info(self, include_sensitive: bool, process_count: int) -> Dict[str, Any]:
