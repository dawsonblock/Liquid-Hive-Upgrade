          ...
          <Paper variant='outlined' sx={{ p: 2 }}>
            ...
            <Box sx={{ mt: 2 }}>
              ...
              <Typography variant='body2' color='text.secondary'>
                {stateSummary?.operator_intent ?? 'Unknown'}
              </Typography>
            </Box>
            {preview.length > 0 && (
              <Box sx={{ mt: 2 }}>
          ...
          <Paper variant='outlined' sx={{ p: 2 }}>
            ...
            {swarm?.nodes && (
              <Typography variant='caption' sx={{ whiteSpace: 'pre-wrap' }}>
                {JSON.stringify(swarm.nodes, null, 2)}
              </Typography>
            )}
          </Paper>
        </Grid>
          ...
          <Paper variant='outlined' sx={{ p: 2 }}>
            ...
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1} sx={{ mt: 1 }}>
              <TextField
                ...
                sx={{ minWidth: 220 }}
              />
              <Button size='small' variant='outlined' onClick={onApplyThresholds}>
                Apply
              </Button>
            </Stack>
            <Typography variant='caption' color='text.secondary'>
              Requires ADMIN_TOKEN configured on server.
            </Typography>
          </Paper>
        </Grid>
      </Grid>
