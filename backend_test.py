...
class ComprehensiveBackendTester:
    ...
    def test_planner_service(self):
        ...
        data = {"q": "Create a simple plan to analyze data"}
        return self.run_test("Planner Service", "POST", "api/chat", 200, data)
    ...
    def test_chat_endpoint(self):
        ...
        data = {"q": "What is artificial intelligence?"}
        return self.run_test("Chat Endpoint", "POST", "api/chat", 200, data)
